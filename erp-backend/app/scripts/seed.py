...
def seed_rbac_data(session: Session, state: dict[str, list[Any]]):
    ...
    modules = seed_rows(session, "rbac_modules", [
        {"name": "Dashboard", "code": "dashboard", "description": "Dashboard module"},
        {"name": "Users", "code": "users", "description": "Users module"},
        {"name": "Roles", "code": "roles", "description": "Roles module"},
        {"name": "Module Registry", "code": "modules", "description": "Module registry"},
        {"name": "Security Center", "code": "security", "description": "Security center"},
        {"name": "Organization Management", "code": "organization", "description": "Organization management"},
        {"name": "Program Management", "code": "program", "description": "Academic programs"},
        {"name": "Batch Management", "code": "batch", "description": "Batch management"},
        {"name": "Student Management", "code": "student", "description": "Students"},
        {"name": "Mentor Profile", "code": "mentor", "description": "Mentors"},
        {"name": "LMS Dashboard", "code": "lms", "description": "Learning management"},
        {"name": "Attendance Dashboard", "code": "attendance", "description": "Attendance"},
        {"name": "Task Dashboard", "code": "task", "description": "Tasks"},
        {"name": "Assessment Dashboard", "code": "assessment", "description": "Assessments"},
        {"name": "Submissions", "code": "submission", "description": "Submissions"},
        {"name": "Performance", "code": "performance", "description": "Performance"},
        {"name": "Communication Center", "code": "communication", "description": "Messages and email"},
        {"name": "Notification Center", "code": "notification", "description": "Notifications"},
        {"name": "Calendar", "code": "calendar", "description": "Calendar"},
        {"name": "Email", "code": "email", "description": "Email templates"},
        {"name": "Certificate", "code": "certificate", "description": "Certificates"},
        {"name": "Document", "code": "document", "description": "Documents"},
        {"name": "Placement", "code": "placement", "description": "Placement"},
        {"name": "Alumni", "code": "alumni", "description": "Alumni"},
        {"name": "Analytics", "code": "analytics", "description": "Analytics"},
        {"name": "Reports", "code": "reports", "description": "Reports"},
        {"name": "Help Desk", "code": "helpdesk", "description": "Help desk"},
        {"name": "Digital ID", "code": "idcard", "description": "ID card"},
        {"name": "Self Service", "code": "selfservice", "description": "Self service"},
        {"name": "Productivity", "code": "productivity", "description": "Productivity"},
    ], state)
