...
const MODULES = [
  { id: 'lms', name: 'LMS', desc: 'Learning Management System for courses and materials.' },
  { id: 'assessment', name: 'Assessment', desc: 'Create and grade quizzes and exams.' },
  { id: 'attendance', name: 'Attendance', desc: 'Track and manage student attendance.' },
  { id: 'task', name: 'Task', desc: 'Assign and track student tasks.' },
  { id: 'submission', name: 'Submission', desc: 'Manage project submissions.' },
  { id: 'performance', name: 'Performance', desc: 'View analytics and performance metrics.' },
  { id: 'certificate', name: 'Certificate', desc: 'Generate and issue certificates.' },
  { id: 'dashboard', name: 'Dashboard', desc: 'Access to system overview.' },
];
...
export function CreateRoleWizard({ isOpen, onClose }: CreateRoleWizardProps) {
  ...
  const [assignedModules, setAssignedModules] = useState<string[]>(['lms', 'assessment', 'attendance']);
  const [expandedModules, setExpandedModules] = useState<string[]>(['lms']);
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              {assignedModules.map(moduleId => {
                ...
                const perms = PERMISSIONS[moduleId as keyof typeof PERMISSIONS] || ['View', 'Create', 'Edit', 'Delete'];
