...
const GLOBAL_SEARCH_ROUTES = [
  { name: 'Organizations', path: '/admin/organization', description: 'Manage colleges and institutions' },
  { name: 'Employees', path: '/admin/employee', description: 'Manage staff and HR' },
  { name: 'Programs', path: '/admin/programs', description: 'Manage internships and training' },
  { name: 'Batches', path: '/admin/batches', description: 'Manage program batches' },
  { name: 'Allocations', path: '/admin/allocation', description: 'Manage assignments' },
  { name: 'Students', path: '/admin/students', description: 'Manage student records' },
  { name: 'Applications', path: '/admin/applications', description: 'Review internship applications' },
  { name: 'Opportunities', path: '/admin/opportunity', description: 'Manage openings' },
  { name: 'Sessions', path: '/admin/sessions', description: 'Active user sessions' },
  { name: 'Permissions', path: '/admin/permissions', description: 'Role access control' },
  { name: 'Security', path: '/admin/security', description: 'Security policies and logs' },
];
...
export function TopNav({ setMobileOpen }: TopNavProps) {
  ...
  const filteredRoutes = GLOBAL_SEARCH_ROUTES.filter(r => 
      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <div className="relative flex flex-1 items-center" ref={searchRef}>
          ...
          <input
            ...
            placeholder="Search modules (e.g. Employees, Batches)..."
            type="text"
            value={searchQuery}
            onChange={(e) => {
